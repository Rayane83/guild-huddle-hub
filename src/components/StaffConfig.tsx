...
export function StaffConfig({ guildId, currentRole }: StaffConfigProps) {
  return (
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-muted-foreground">
            La configuration du staff est temporairement indisponible pendant la reconstruction de la base de données.
            Cette fonctionnalité sera rétablie sous peu avec une interface de gestion simplifiée.
          </p>
