  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h2 className="text-2xl font-bold">Dotation</h2>
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-muted-foreground">
            Le système de dotation est temporairement indisponible pendant la reconstruction de la base de données.
            Cette fonctionnalité sera rétablie sous peu avec la nouvelle structure simplifiée basée sur les rapports de paie.
          </p>
